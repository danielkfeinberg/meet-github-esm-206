...
### Cool animal fun facts (the information in the curly braces allows for interactive components in the knitted document in all headers below that of the current header (level 4 and further) "{.tabset .tabset-fade}") {.tabset .tabset-fade}
...
Here's where I want to have info on ring-tails. 
